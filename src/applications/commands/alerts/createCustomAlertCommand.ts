...
const execute = async (interaction: ChatInputCommandInteraction) => {
  ...
  const pleft = interaction.options.getString("pleft") ?? undefined;
  const pright = interaction.options.getString("pright") ?? undefined;
  const op = interaction.options.getString("op") ?? undefined;
  const tleft = interaction.options.getString("tleft") ?? undefined;
  const tright = interaction.options.getString("tright") ?? undefined;
