...
export type CommandExecuteFunctionMap = Record<
  string,
  (interaction: ChatInputCommandInteraction<CacheType>) => void
>;

export const AuthorizationHeaders = Type.Object({
  cookies: Type.String(),
});

export type AuthorizationHeaders = Static<typeof AuthorizationHeaders>;
